...
{
	mlx_destroy_image(sl->mlx_ptr, sl->dead.i.img);
	mlx_destroy_image(sl->mlx_ptr, sl->wins.i.img);
	mlx_destroy_image(sl->mlx_ptr, sl->over.i.img);
	...
	mlx_destroy_image(sl->mlx_ptr, sl->enm.i.img);
